...
use DoppioGancio\Jira\Domain\ReleaseSearchResult;
...
class ReleaseRepositoryTest extends TestCase
{
    public function testList(): void
    {
        ...
        $this->assertEquals('https://sourceability.atlassian.net/rest/api/3/project/PM/version?maxResults=3&orderBy=-releaseDate&startAt=0', $result->getSelf());
        $this->assertEquals('https://sourceability.atlassian.net/rest/api/3/project/PM/version?maxResults=3&orderBy=-releaseDate&startAt=3', $result->getNextPage());
        ...
        $this->assertEquals('https://sourceability.atlassian.net/rest/api/3/version/10538', $release->getSelf());
